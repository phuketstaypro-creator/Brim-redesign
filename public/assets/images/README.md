# Происхождение восстановленных изображений

Эта папка содержит только технически восстановленные файлы из исходников
репозитория. Новые изображения не создавались, а отсутствующие части данных не
дорисовывались.

...
- Исходник передан заказчиком 2 сентября 2026 года как JPEG 1280 x 508 с белой подложкой и SHA-256 `1048bf5ebf4520f0449686f71320ce467b2261733dc9b61c7d551ede76bbb320`.
- Белая подложка удалена детерминированно по её цвету; сохранён доминирующий красный цвет исходника `#da2127`, исходные очертания и пропорции знака.
- Итоговый прозрачный PNG имеет размер 756 x 410 и SHA-256 `0c62c39436b94bedf82ed5b20f220e130f337541c3c4ede8eb0e16278c6a9f33`.

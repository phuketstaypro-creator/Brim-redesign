...
- `/sveden/` и 14 обязательных подразделов входят в route contract;
...
- `/sveden/*` содержит обязательную структуру маршрутов, но не импортированные официальные сведения и документы.

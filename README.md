...
Статически генерируемый frontend Бурятского республиканского хореографического колледжа. `npm run build` создаёт в `dist/` отдельный наполненный HTML-документ для каждого публичного маршрута. JavaScript используется только для progressive enhancement меню, поиска, пользовательских настроек и точной упаковки новостной masonry-сетки; основной текст, ссылки и изображения уже присутствуют в HTML ответа.

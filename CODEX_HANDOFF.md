...
Текущая логика в `classifyEditorialCards()`:
...
- стабильная сетка при lazy loading;
- зарезервированные размеры без layout shift;
- одинаково хорошая работа при 1, 2, 3, 6, 20+ новостях;
- адаптивная одноколоночная лента на телефоне.
